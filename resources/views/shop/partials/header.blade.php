...
<body>
    ...
    <div class="main-content-wrapper d-flex clearfix">
        ...
        <header class="header-area clearfix">
            ...
            <!-- Logo -->
            <div class="logo">
                <a href="{{route('home')}}"><img src="{{asset('amado-master/img/core-img/logo.png')}}" alt=""></a>
            </div>
            <!-- Amado Nav -->
            <nav class="amado-nav">
                <ul>
                    ...
                    <li><a href="{{route('detail')}}">Product</a></li>
            ...
            <div class="cart-fav-search mb-100">
                <a href="cart.html" class="cart-nav"><img src="{{asset('amado-master/img/core-img/cart.png')}}" alt=""> Cart <span>(0)</span></a>
