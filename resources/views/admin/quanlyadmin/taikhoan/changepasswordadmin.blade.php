                            ...
                            <div class="user-content">
                                @if ($thongtin->hinhdaidien != null)
                                    <a href="javascript:void(0)">
                                        <img src="{{asset('uploads/'.$thongtin->hinhdaidien)}}" class="thumb-lg img-circle" alt="img">
                                    </a>
                                @else
                                    <a href="javascript:void(0)">
                                ...
                                @endif
                                <h4 class="text-white mt-2">{{$thongtin->tendangnhap}}</h4>
                                <h5 class="text-white mt-2">{{$thongtin->email}}</h5>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-8 col-xlg-9 col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form acction="{{route('postchangepassadin',['TK'=>$thongtin->id])}}" method="post" enctype="multipart/form-data">
                             @csrf
